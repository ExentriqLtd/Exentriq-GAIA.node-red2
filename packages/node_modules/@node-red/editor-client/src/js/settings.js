        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data && data.result && data.result.name){
                    ...
                    console.log('HEADER!!!!!?');
                    console.log($('#red-ui-header'));
                    $('#red-ui-header').prepend('<div id="robot" class="robot"><a id="robot-back" href="#" class="robot-back"><i class="material-icons">keyboard_arrow_left</i></a><a class="robot-name" href="#">'+robot_name+'</a></div>');
