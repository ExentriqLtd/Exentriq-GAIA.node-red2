...
RED.utils = (function() {
    ...
    function buildMessageElement(obj,options) {
        ...
        if (obj === null || obj === undefined) {
            ...
            if(obj.startsWith('http://') || obj.startsWith('https://')){
                e = $('<span class="red-ui-debug-msg-type-string red-ui-debug-msg-object-header"></span>');
                var ll = $('<a style="color:#08c" target="_blank" href="'+obj+'">'+obj+'</a>');
                ll.appendTo(e);
                e.appendTo(entryObj);
            }
            else{
    ...
    function getOwner(user){
        ...
        var company_piece = user.company;
