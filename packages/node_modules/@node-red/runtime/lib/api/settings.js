        ...
        return new Promise(function(resolve,reject) {
            try {
                ...
                if (opts.user) {
                    ...
                    var props = ["anonymous","username","image","permissions","company","group", "exentriq_token"];
                    props.forEach(prop => {
                ...
                if(runtime.settings.exentriq){
                    safeSettings.exentriq = runtime.settings.exentriq;
                }
