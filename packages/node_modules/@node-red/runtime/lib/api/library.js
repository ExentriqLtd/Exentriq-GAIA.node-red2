...
var api = module.exports = {
    ...
    */
    getEntry: function(opts) {
        return new Promise(function(resolve,reject) {
            // GAIA Multitenant
            runtime.library.getEntry(opts.library,opts.type,opts.path, opts.user).then(function(result) {
    ...
    */
    saveEntry: function(opts) {
        return new Promise(function(resolve,reject) {
            // GAIA Multitenant
            runtime.library.saveEntry(opts.library,opts.type,opts.path,opts.meta,opts.body,opts.user).then(function() {
