    ...
    */
    getFlows: function(opts) {
        return new Promise(function(resolve,reject) {
            ...
            // GAIA Multitenant
            return resolve(runtime.nodes.getFlows(opts.user));
        });
    },
    /**
        ...
        return new Promise(function(resolve,reject) {
            ...
            if (deploymentType === 'reload') {
                ...
                if (flows.hasOwnProperty('rev')) {
                    // GAIA Multitenant
                    var currentVersion = runtime.nodes.getFlows(opts.user).rev;
                ...
                // GAIA Multitenant
                apiPromise = runtime.nodes.setFlows(flows.flows,deploymentType, null, null, opts.user);
            }
